  ...
  <div class="live-activity-feed card">
    ...
    <div class="activity-stream" ref="streamRef">
      <TransitionGroup name="activity-fade">
        ...
        >
          <div class="activity-avatar">
            <img
              :src="activity.user?.avatar || '/static/images/default-avatar.png'"
      ...
      <div v-if="activities.length === 0" class="empty-state">
        ...
        <p class="empty-text">Henuz aktivite yok</p>
        <p class="empty-subtext">Ilk konuyu sen ac!</p>
      </div>
    </div>
  </div>
</template>
