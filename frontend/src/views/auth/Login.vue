  ...
  <div class="relative min-h-screen flex items-center justify-center px-4 py-12 overflow-hidden">
    ...
    <div class="w-full max-w-md relative z-10">
      ...
      <div class="text-center mb-8 fade-in-up">
        ...
        <p class="text-text-secondary text-lg">Steam ile giriş yapın</p>
      </div>
      ...
      <div class="glass-card p-10 neon-border fade-in-up delay-100">
        ...
        <div class="text-center mb-8">
          ...
          <h2 class="text-2xl font-bold text-white mb-2">Steam ile Giriş</h2>
          <p class="text-text-secondary">
            Steam hesabınızla güvenli giriş yapın.<br/>
            Profil bilgileriniz otomatik olarak güncellenir.
          </p>
        </div>
        ...
        >
          ...
          <span class="text-lg font-bold">Steam ile Devam Et</span>
        ...
        <div class="mt-6 p-4 bg-primary/10 border border-primary/30 rounded-lg">
          <p class="text-sm text-text-secondary text-center">
            <span class="text-primary font-semibold">🔒 Güvenli</span> ·
            Steam OpenID kullanılır ·
            Şifreniz istenmez
          </p>
        </div>
      </div>
