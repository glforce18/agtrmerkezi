          ...
          <BaseCard variant="glass" shadow>
            ...
            <div class="space-y-3 mb-6">
              <button
                ...
                class="btn btn-block bg-[#171a21] hover:bg-[#0a0b0e] text-white border-0 gap-2 flex items-center justify-center"
                :disabled="loading"
              >
                ...
                <span class="truncate">Steam ile Giriş</span>
              </button>

              <button
                @click="loginWithOAuth('discord')"
                class="btn btn-block bg-[#5865F2] hover:bg-[#4752C4] text-white border-0 gap-2 flex items-center justify-center"
                :disabled="loading"
              >
                <svg class="w-5 h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                ...
                <span class="truncate">Discord ile Giriş</span>
              </button>
              ...
              >
                ...
                <span class="truncate">Google ile Giriş</span>
              </button>
            </div>
